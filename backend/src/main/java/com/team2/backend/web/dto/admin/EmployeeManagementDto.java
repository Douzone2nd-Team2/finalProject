...
public class EmployeeManagementDto{
    ...
    @QueryProjection
    public EmployeeManagementDto(Long no, String name, String userId, String birth, String phone, String email, String empNo, String deptName, String gradeName, String imageUrl){
        this.no = no;
        this.name = name;
        this.userId = userId;
        this.birth = birth;
    ...
    @QueryProjection
    public EmployeeManagementDto(Long no, String name, String empNo, String deptName, String gradeName){
        this.no = no;
        this.name = name;
        this.empNo = empNo;
        this.deptName = deptName;
